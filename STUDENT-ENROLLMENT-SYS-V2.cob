      ...
      *FILE ASSIGNMENT (INPUT AND OUTPUT)
       FILE-CONTROL.
           ...
           SELECT ENROLL-IN ASSIGN TO 'ENROLLS.txt'.
           SELECT GRADES-IN ASSIGN TO 'GRADESS.txt'.
       DATA DIVISION.
       FILE SECTION.
       FD  SUBJECT-IN
      ...
      *HEADERS TO USE
       ...
       SECOND-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-SECOND
               ADD 1 TO GRAND-TOTAL-ENROLL
              MOVE TOTAL-SECOND TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF2-EN.
       ...
       THIRD-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-THIRD
               ADD 1 TO GRAND-TOTAL-ENROLL
               MOVE TOTAL-THIRD TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF3-EN.
       ...
       FOURTH-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-FOURTH
               ADD 1 TO GRAND-TOTAL-ENROLL
               MOVE TOTAL-FOURTH TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF4-EN.
       ...
       FIFTH-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-FIFTH
               ADD 1 TO GRAND-TOTAL-ENROLL
               MOVE TOTAL-FIFTH TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF5-EN.
       ...
       SIXTH-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-SIXTH
               ADD 1 TO GRAND-TOTAL-ENROLL
               MOVE TOTAL-SIXTH TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF6-EN.
       ...
       SEVENTH-COMP-RTN.
           IF CODE-SUBJECT = SUBJECT-CODE
               ADD 1 TO TOTAL-SEVENTH
               ADD 1 TO GRAND-TOTAL-ENROLL
               MOVE TOTAL-SEVENTH TO TOTAL-EN-NUM
               PERFORM ENROLL-ADD-RTN.
           READ STUDENT-IN AT END MOVE 'YES' TO EOF7-EN.
